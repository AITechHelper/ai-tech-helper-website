...
/* Site-wide footer, used on every normal scrolling page (the AI Tools and AI
   Hub sections and the package pages). The homepage's resting state is the
   fixed services stage, so it has no natural bottom for this to sit under. */
    ...
    <footer className="site-footer">
      <div className="footer-inner">
        ...
        <nav className="footer-col" aria-label="Services">
          <h3>Services</h3>
          <Link href="/#services">AI Receptionist Agent</Link>
          <Link href="/#services">AI Chat Bot</Link>
        </nav>
